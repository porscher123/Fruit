...
public interface FruitService {
    ...
    // 添加库存
    void  addFruit(Fruit fruit) throws SQLException, NoSuchFieldException, InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException;
